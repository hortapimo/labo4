...
# Listamos todos los recursos disponibles (USB, GPIB, Serial, etc.)
recursos = rm.list_resources()

print(recursos)
#%%
lectorCanales= Agilent34970A_multiplexor.Agilent34970A(name= 'ASRL3::INSTR')
distancias=np.array([81.4, 123.1, 164, 211.9, 249.6, 410.5])
#generadorSeniales= tek.AFG3021B('USB0::0x0699::0x0346::C034167::INSTR')
#%% Prueba rapida
time.sleep(1)
...
archivo_datos = "respuesta_del_sistema_a_señal_senoidal.csv"
